function Feature({ header, index, details}) {
  ...
  return (
    <li className=" text-center flex xl:flex-col gap-8 xl:gap-5 justify-center">
        <div className="header min-w-32 xl:w-fit text-white font-semibold flex flex-col gap-2">
        ...
        <ul className="font-extralight text-base text-left xl:text-center xl:text-xl">
            {
                details.map((d, indx) => {
                    return (
                        <li key={indx}>• {d}</li>
