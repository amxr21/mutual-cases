...
function Features() {
  ...
  return (
    <MainSection Id="Features" classes="banner items-center bg-blue gap-8 xl:gap-0 px-8 xl:px-20 py-8 xl:py-16 -mx-8 xl:-mx-20 text-white">
        <Header textColor="white" textAlignment="center" headerText="We offer three types of iPad cases" subheaderText="Each has specific functions to match your needs!" subheader={true} mark={false} />
